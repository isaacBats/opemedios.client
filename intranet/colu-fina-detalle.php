...
//---------------------------------------------------------------------
$query = "SELECT a.fecha,a.titulo,a.autor, a.imagen_jpg imagen,
                a.id_columna_financiera id,b.nombre fuente,
a.contenido, a.archivo_pdf archivo
FROM columna_financiera a, fuente b
where a.id_fuente = b.id_fuente and a.id_columna_financiera = ".$_GET['id'];
...
<html>
<head>
	<title>Columnas Financieras - OPEMEDIOS</title>
