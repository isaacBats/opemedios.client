...
<b><font class="titulo-azul">Columnas Pol&iacute;ticas</font></b><br>
<?php if($acceso == 3){
echo '<form name="form1" method="get" action="colu-poli.php">
...
<?php
                                    ...
                                    if($columna == 1) {
                                        ...
                                        echo'	<td width="60">
                                                ...
                                                <td valign="top" class="desarrollo">
                                                <b><a href="colu-poli-detalle.php?id='.$row_query['id'].'" class="desarrollo">'.utf8_encode($row_query['titulo']).'</a></b><br>
