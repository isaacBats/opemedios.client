...
$base->execute_query("SELECT id_tema, nombre FROM tema where id_empresa =".$current_account->get_id()." ORDER BY nombre ASC");
$arreglo_temas = array();
...
<table border="0" align="center" width="100%">
        ...
        <hr width="100%" size="1" noshade="noshade" color="#000066">
         FIN tabla noticia grande medio electronico -->
			...
			if($num_noticias1 > 0)
			{
				foreach($arreglo_noti1 as $id_not => $idtf)
				{
					//echo $id_not." -> ".$idtf."<br><br>";
					echo muestra_noticia_grande($base,$id_not,$idtf);
				}
			}
			//echo '<hr color="#000066">';
			if($num_noticias2 > 0)
			{
				foreach($arreglo_noti2 as $id_not => $idtf)
				{
					//echo $id_not." -> ".$idtf."<br><br>";
					echo muestra_noticia_grande($base,$id_not,$idtf);
			...
			if($num_noticias3 > 0)
			{
				foreach($arreglo_noti3 as $id_not => $idtf)
				{
					//echo $id_not." -> ".$idtf."<br><br>";
					echo muestra_noticia_grande($base,$id_not,$idtf);
