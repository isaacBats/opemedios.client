...
$parametro = "-1";
if (isset($_GET['id_tipo_fuente'])) {
  $parametro = $_GET['id_tipo_fuente'];
}

$query_fuentes = sprintf("SELECT * FROM fuente WHERE id_tipo_fuente=%s ORDER BY nombre", GetSQLValueString($parametro, "int"));
