//creo array de imágenes 
 ...
 array_imagen[0].src = "images/banner/Banner1.png";
 array_imagen[1] = new Image(680,90);
 array_imagen[1].src = "images/banner/Banner2.jpg";
 array_imagen[2] = new Image(680,90); 
 array_imagen[2].src = "images/banner/Banner3.png";
 ...
 function alternar_banner(){ 
     ...
     //window.document["link"].href = array_url[contador];
	 window.document.links.namedItem("link").href = array_url[contador];
     contador ++;
